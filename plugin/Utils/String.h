...
namespace Utils { namespace String {
	...
	std::wstring replace(const std::wstring& base, const re::RegExp& re, const std::wstring& str);
	std::vector<std::wstring> split(const std::wstring& base, const std::wstring& separator);
	bool match(re::RegExpMatch& match, const std::wstring& base, const re::RegExp& re);
